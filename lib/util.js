...
export function help() {
	...
	new : ${clor.cyan('Account used for identification.')} ${clor.yellow('[ > twitbot new	]')}
	help : ${clor.cyan('Used to display the Help command.')} ${clor.yellow('[ > twitbot help	]')}
	live : ${clor.cyan('Follow live tweets sent. ')} ${clor.yellow('[ > twitbot live	]')}
	start : ${clor.cyan('Bots used to start operations.')} ${clor.yellow('[ > twitbot start	]')}
	message : ${clor.cyan('It sends a message to all followers.')} ${clor.yellow('[ > twitbot mesaj	]')}
	forever : ${clor.cyan('Background allows the operation of the bots.')} ${clor.yellow('[ > twitbot forever ]')}
	...
	${clor.yellow('[ > twitbot forever --notification	]')}

	Background To Stop Working Bots
	${clor.yellow('[ > twitbot forever --stop	]')}
